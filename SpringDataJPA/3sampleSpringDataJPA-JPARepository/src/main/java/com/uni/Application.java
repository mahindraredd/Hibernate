...
//		});
//	
		//service.findVaccinesByCompany(2).forEach(System.out::println);
//		List<Object[]> names=service.fetchvaccinesByPriceRange(300, 400);
...
//			System.out.println();
//		}
		System.out.println(service.modifyprice(1000, 105L));
